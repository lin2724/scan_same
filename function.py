    ...
    def store_file_record(self, full_file_path, hash_code, description=None):
        ...
        try:
            ...
            self.dbHandle.execute('INSERT OR REPLACE INTO hash_record VALUES (?,?,?,?)',
                                (full_file_path, hash_code, description, same_count))
